...
const Weatherdetails = () => {
    ...
    return (
        <div>
            <h3 style={{ textAlign: 'center', marginBottom: '100px' }}> Current Weather Condition of {weatherdata.capital}</h3>


            <Card style={{ boxShadow: '2px 3px #888888' }} variant='outlined' sx={{ display: 'flex', ml: 70, mr: 70 }}>
                    ...
                    <Box sx={{ display: 'flex', flexDirection: 'column' }}>
                        <CardContent sx={{ flex: '1 0 auto' }}>
                            ...
                            <Typography variant="h6" color="text.secondary" component="div">
                                Temp : {weatherdata.Temp} Degree Celsius
                            </Typography>
                            <Typography variant="h6" color="text.secondary" component="div">
